"""Define the agents used in the book generation system - Updated for AutoGen v2"""
...
class BookAgents:
    ...
    def create_agents(self, initial_prompt, num_chapters) -> Dict:
        ...
        model_client = self.agent_config["model_client"]
        
        # Memory Keeper: Maintains story continuity and context
        memory_keeper = AssistantAgent(
            name="memory_keeper",
